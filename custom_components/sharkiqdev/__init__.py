...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    # Load room maps once at startup; they are cached in coordinator.extended_vacs
    # and survive subsequent polling updates.
    await coordinator.async_load_room_maps()
